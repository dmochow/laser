...
for s=1:nSubjects
    ...
    cd(pathToData);
    str11=['!@auto_tlrc -apar anat+tlrc -input ' Aprefix '+orig'] ; eval(str11); % register A to anatomy
    str11a=['!gunzip ' Aprefix '+tlrc.BRIK.gz']; eval(str11a); % weird that this is needed
    str13=['!3dresample -master dsbold_e2_tlrc_al+tlrc -prefix resampled_' Aprefix ' -input ' Aprefix '+tlrc']; eval(str13);  % resample A on bold grid
