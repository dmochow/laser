...
filenames={'thresh_isSigBefDur_s8muwBoldEcho1-Filter1-Derivative1-WhiteMatter3-STANDARDIZE1-TSHIFT1-CSHIFT2+tlrc.BRIK',...
    'thresh_isSigBefDur_s8muwBoldEcho2-Filter1-Derivative1-WhiteMatter3-STANDARDIZE1-TSHIFT1-CSHIFT2+tlrc.BRIK',...
    'thresh_isSigBefDur_s8muwBoldEcho3-Filter1-Derivative1-WhiteMatter3-STANDARDIZE1-TSHIFT1-CSHIFT2+tlrc.BRIK'};
arFilenames={'arCoeffsResidsEcho1.mat','arCoeffsResidsEcho2.mat','arCoeffsResidsEcho3.mat'};
...
for e=1:nFilenames
    ...
    %coeffsPreStim(1,:,:)=1; % hack because idk what I'm doing yet
    %coeffsPreStim(2:end,:,:)=-coeffsPreStim(2:end,:,:); %
    ...
    %coeffsPrePost(2:end,:,:)=-coeffsPrePost(2:end,:,:); %
    %coeffsPrePost(1,:,:)=1; % hack because idk what I'm doing yet
    %coeffsPrePost(2:end,:,:)=-coeffsPrePost(2:end,:,:); %
...
set(hlg1,'Position',[lgPos(1)-0.14 lgPos(2)+0.04 lgPos(3) lgPos(4)]);
lgPos=get(hlg2,'Position');
set(hlg2,'Position',[lgPos(1) lgPos(2)+lgDelUp lgPos(3) lgPos(4)]);
%
%%
sublabel([hs(1) hs(4) hs(7)],-10,-40,'FontSize',16,'FontWeight','Bold');
