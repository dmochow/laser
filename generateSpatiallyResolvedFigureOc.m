...
optionStr=['-Filter1-Derivative1-WhiteMatter3-STANDARDIZE1-TSHIFT1-CSHIFT2'];
dataFilename=['s' FWHMSTR 'muocBold' optionStr '+tlrc'];
%s8muocBold-Filter1-Derivative1-WhiteMatter3-STANDARDIZE1-TSHIFT1-CSHIFT2+tlrc.BRIK
...
% pre vs during
prefix=['oc_isSigBefDur_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
view='tlrc';
...
%%
% pre vs after
prefix=['oc_isSigBefAft_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
...
%% tstat volumes
% before vs during
prefix=['oc_tstatsBefDur_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
view='tlrc';
...
% before vs after
prefix=['oc_tstatsBefAft_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
view='tlrc';
...
threshprefix=['thresh_oc_isSigBefDur_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
str=['!3dresample -master TT_N27+tlrc -prefix resampled_' threshprefix ' -input ' threshprefix '+tlrc'];
eval(str);

threshprefix=['thresh_oc_isSigBefAft_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
str=['!3dresample -master TT_N27+tlrc -prefix resampled_' threshprefix ' -input ' threshprefix '+tlrc'];
eval(str);

% resample tstat images onto anat grid
threshprefix=['oc_tstatsBefDur_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
str=['!3dresample -master TT_N27+tlrc -prefix resampled_' threshprefix ' -input ' threshprefix '+tlrc'];
eval(str);

threshprefix=['oc_tstatsBefAft_NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '_' dataFilename(1:end-5)]; % remove +tlrc
str=['!3dresample -master TT_N27+tlrc -prefix resampled_' threshprefix ' -input ' threshprefix '+tlrc'];
eval(str);
...
save(['../data/SAVG/NII/oc_arCoeffsResidsEcho-NLAGS' num2str(NLAGS) '_CONSTANT' num2str(CONSTANT) '.mat'],'coeffsPreStim','coeffsPrePost');
